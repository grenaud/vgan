...
tuple<vector<NodeInfo *>, int, bdsg::ODGI,vector<vector<bool>>, vector<string>> Euka::readPathHandleGraph (string & ogfilename, int n_threads,\
                               string &gbtwfilename, string &db_prefix,  vector<Clade *> * & clade_vec) {
