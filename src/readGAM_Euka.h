...
#ifdef DEBUGDAMAGE2
                cerr<<a.name()<<","<<(in_clade_lik - not_in_clade_lik)<< "," << clade_vec->at(c_n*3 +1)->name <<endl; 
#endif
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (
                ...
                //(entropy_score > ENTROPY_SCORE_THRESHOLD) 
                    ...
                    clade_vec->at(c_n*3 +1)->count++;
                    clade_vec->at(c_n*3+1)->inSize.emplace_back(a.sequence().size());
                    clade_vec->at(c_n*3+1)->nameStorage.emplace_back(a.name());
...
#ifdef VERBOSE_S
            cerr << "The clade " << clade_vec->at(i*3+1)->name << " could not be detected." << endl;
...
#ifdef VERBOSE_S
            cerr << "Clade " << clade_vec->at(i*3+1)->name << " is present in the sample." << endl;
#endif
